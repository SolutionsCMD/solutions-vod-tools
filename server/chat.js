...
function startYoutubeChat(streamUrl, sessionDir, log, ytdlpPath, cookiesFile, cookiesFromBrowser) {
  ...
  // cookies.txt (from in-app sign-in) wins over the browser dropdown.
  if (cookiesFile) {
...
// Public API
// ============================================================
function startChatCapture({ platform, channel, sessionDir, lastStatus, streamUrl, ytdlpPath, cookiesFile, cookiesFromBrowser }, log) {
  ...
  switch (platform) {
    ...
    case 'youtube': return startYoutubeChat(streamUrl, sessionDir, safeLog, ytdlpPath, cookiesFile, cookiesFromBrowser);
    default:
