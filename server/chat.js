...
function startYoutubeChat(streamUrl, sessionDir, log, ytdlpPath, cookiesFile) {
...
// Public API
// ============================================================
function startChatCapture({ platform, channel, sessionDir, lastStatus, streamUrl, ytdlpPath, cookiesFile }, log) {
  ...
  switch (platform) {
    ...
    case 'youtube': return startYoutubeChat(streamUrl, sessionDir, safeLog, ytdlpPath, cookiesFile);
    default:
